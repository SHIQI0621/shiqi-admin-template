export default class Subtitle extends EventEmitter<string | symbol, any> {
    ...
    innerRoot: HTMLElement | null | undefined;
    detachPlayer(): void;
    switch(subtitle?: {
        id: string;
        language: string;
    ...
    getUpdateData(texts: any, currentTime: any, currentText: any): {
        type: string;
        currentTime: number;
        id: any;
        language: any;
