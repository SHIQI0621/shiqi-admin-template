...
declare class MobilePlugin extends Plugin {
    ...
    xgMask: HTMLElement | null | undefined;
    touch: Touche | null | undefined;
    ...
    touchActiveTimer: number | null | undefined;
    ...
    switchPlayPause(): false | undefined;
    disableGesture(): void;
    enableGesture(): void;
    render(): string;
}
