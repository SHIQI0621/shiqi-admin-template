 ...
 */
export function saveAs(data: string | Blob | ArrayBuffer, fileNameOrOptions?: string | SaveAsOptions, mimeType?: string): boolean | Promise<any>;
/**
 ...
 */
export function saveAsWithAuth(url: string, options?: SaveAsOptions): Promise<Blob>;
/**
