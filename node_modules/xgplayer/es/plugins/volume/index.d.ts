...
declare class Volume extends Plugin {
    ...
    changeMutedHandler: ((...args: any[]) => void) | undefined;
    _onMouseenterHandler: ((...args: any[]) => void) | undefined;
    _onMouseleaveHandler: ((...args: any[]) => void) | undefined;
    onBarMousedown: (e: any) => false | undefined;
    pos: {
        x: number;
        y: number;
        clientX: number;
